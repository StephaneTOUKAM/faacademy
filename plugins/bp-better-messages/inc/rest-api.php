...
if ( !class_exists( 'Better_Messages_Rest_Api' ) ):
    ...
    class Better_Messages_Rest_Api
    {
        ...
        public function get_pm_thread( WP_REST_Request $request ){
            ...
            if( empty( $uniqueKey ) ){
                $result = Better_Messages()->functions->get_pm_thread_id( $user_id, get_current_user_id(), $create, $subject );
            } else {
                $result = Better_Messages()->functions->get_unique_pm_thread_id( $uniqueKey, $user_id, get_current_user_id(), $create, $subject );
            }
        ...
        public function get_threads( $thread_ids = [], $fetch_messages = true, $fetch_users = true, $personal_data = true, $cache = true, $user_id = false ){
            ...
            foreach ( $get_threads as $thread ){
                ...
                $thread_item = apply_filters('better_messages_rest_thread_item', $thread_item, $thread_item['thread_id'], $thread_item['type'], $personal_data );
