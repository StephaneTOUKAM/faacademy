...
<div class="wrap">
    ...
    <div class="nav-tab-wrapper" id="bpbm-tabs">
        ...
        <a class="nav-tab" id="export-import-tab" href="#export-import"><?php _ex( 'Export/Import', 'Settings page', 'bp-better-messages' ); ?></a>
    </div>
    <form action="" method="POST">
                ...
                <div class="col secondary-col">
                    ...
                    <?php if( bpbm_fs()->is_premium() && ! Better_Messages()->functions->can_use_premium_code() ){ ?>
                        <div class="bp-better-messages-connection-check bpbm-error">
                            ...
                            <p><?php echo sprintf(_x('If you have license, and it must be attached to this website, try to press sync button in <a href="%s">your account</a>.', 'Settings page','bp-better-messages'), admin_url('admin.php?page=bp-better-messages-account')); ?></p>
                        </div>
        ...
        <div id="export-import" class="bpbm-tab">
            <table class="form-table">
                ...
                <tr valign="top" class="">
                    <th scope="row" valign="top" style="width: 150px;">
                        <?php _ex( 'Import Settings', 'Settings page', 'Settings page', 'bp-better-messages' ); ?>
        ...
        <p class="submit">
            <input type="submit" name="save" id="submit" class="button button-primary"
                   value="<?php _ex( 'Save Changes', 'Settings page', 'bp-better-messages' ); ?>">
        </p>
    </form>
</div>
