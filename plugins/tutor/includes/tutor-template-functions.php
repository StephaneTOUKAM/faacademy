...
if ( ! function_exists('get_tutor_course_subjects')){
    function get_tutor_course_subjects($course_id = 0){
        if ( ! $course_id ) {
            $course_id = get_the_ID();
        }
        $terms = get_the_terms( $course_id, 'course-subject' );
...
if ( ! function_exists('get_tutor_course_topics')){
    function get_tutor_course_topics($course_id = 0){
        if ( ! $course_id ) {
            $course_id = get_the_ID();
        }
        $terms = get_the_terms( $course_id, 'course-topic' );

        return $terms;
    }
}
if ( ! function_exists('get_tutor_course_levels')){
    function get_tutor_course_levels($course_id = 0){
        if ( ! $course_id ) {
            $course_id = get_the_ID();
        }
