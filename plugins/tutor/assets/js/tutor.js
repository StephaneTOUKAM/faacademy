...
jQuery(document).ready(function($){
    ...
    if (jQuery().select2) {
        ...
        var select22 = $('.tutor_select2_rehearsal').select2({
   ...
   $(document).on('click', '.tutor-instructor-feedback', function(e){
    ...
    $(add_new_button).click(function(){
        $('input[name="rehearsal_id"]').val("");
        $('.tutor_rehearsal_type').val("");
        $('.tutor_rehearsal_type_data').val("");
        $('.tutor_rehearsal_language').val("");
        $('input[name="tutor_rehearsal_title"]').val("");
        $('.tutor_rehearsal_description').html("");
        $('input[name="tutor_rehearsal_keywords"]').val("");
        $('.tutor_rehearsal_level').val("");
        $('.tutor_rehearsal_subject').val("");
        $('input[name="tutor_rehearsal_timeslot"]').val("");
        $('input[name="tutor_rehearsal_date"]').val("");
        $('input[name="tutor_rehearsal_hour"]').val("");
        $('input[name="tutor_rehearsal_price"]').val("");
        $('input[name="tutor_rehearsal_platform"]').val("");
        $('input[name="tutor_rehearsal_link"]').val("");
        $('input[name="tutor_rehearsal_identifiers"]').val("");
    ...
    // var add_new_button = $(".tutor-announcement-add-new");
    var update_button_rehearsal = $(".tutor-rehearsal-edit");
    // var delete_button = $(".tutor-announcement-delete");
    var details_button_rehearsal = $(".tutor-rehearsal-details");
    var close_button_rehearsal = $(".tutor-rehearsal-close-btn");
    // var create_modal = $(".tutor-accouncement-create-modal");
    var update_modal_rehearsal = $(".tutor-rehearsal-update-modal");
    var details_modal_rehearsal = $(".tutor-rehearsal-details-modal");
    $(details_button_rehearsal).click(function(){
        var tutor_rehearsal_id = $(this).attr('rehearsal-id');
        var tutor_rehearsal_type = $(this).attr('rehearsal-type');
        var tutor_rehearsal_type_data = $(this).attr('rehearsal-type-data');
        var tutor_rehearsal_file = $(this).attr('rehearsal-file');
        var tutor_rehearsal_title = $(this).attr('rehearsal-title');
        var tutor_rehearsal_description = $(this).attr('rehearsal-description');
        var tutor_rehearsal_keywords = $(this).attr('rehearsal-keywords');
        var tutor_rehearsal_level = $(this).attr('rehearsal-level');
        var tutor_rehearsal_subject = $(this).attr('rehearsal-subject');
        var tutor_rehearsal_date = $(this).attr('rehearsal-date');
        var tutor_rehearsal_date_to = $(this).attr('rehearsal-date-to');
        var tutor_rehearsal_hour = $(this).attr('rehearsal-hour');
        var tutor_rehearsal_image = $(this).attr('rehearsal-image');
        var tutor_rehearsal_price = $(this).attr('rehearsal-price');
        var tutor_rehearsal_platform = $(this).attr('rehearsal-platform');
        var tutor_rehearsal_link = $(this).attr('rehearsal-link');
        var tutor_rehearsal_identifiers = $(this).attr('rehearsal-identifiers');
        var tutor_rehearsal_language = $(this).attr('rehearsal-language');
        var tutor_rehearsal_date_limite = $(this).attr('rehearsal-date_limite');
        
        var tutor_rehearsal_min_student_number = $(this).attr('rehearsal-min_student_number');
        var tutor_rehearsal_max_student_number = $(this).attr('rehearsal-max_student_number');
        // if
        if (tutor_rehearsal_type_data == "E-Book") {
            $('.rehearsal-submit').hide(100);
            $('.ebook-submit').show(300);
            if (tutor_rehearsal_file != undefined && JSON.parse(tutor_rehearsal_file).length > 0) {
                JSON.parse(tutor_rehearsal_file).forEach((element)=>{
                    $('.toutes-les-images').append(`<a href="${element}" target="_blank">View file | </a>`);
                });
            }
        } else {
            $('.ebook-submit').hide(100);
            $('.rehearsal-submit').show(300);
        }
        $('.rehearsal-ebook-image').attr("src", tutor_rehearsal_image);

        if (tutor_rehearsal_level != undefined && tutor_rehearsal_level != "" && JSON.parse(tutor_rehearsal_level).length > 0) {
            JSON.parse(tutor_rehearsal_level).forEach((element)=>{
                // if(!select22.find('option:contains(' + element + ')').length) 
                //     select22.append($('<option>').val(element));
            });
            select22.val(JSON.parse(tutor_rehearsal_level)).trigger("change"); 
        }
        
        $('input[name="rehearsal_id"]').val(tutor_rehearsal_id);
        $('.tutor_rehearsal_type').val(tutor_rehearsal_type);
        $('.tutor_rehearsal_type_data').val(tutor_rehearsal_type_data);
        $('.tutor_rehearsal_language').val(tutor_rehearsal_language);
        $('input[name="tutor_rehearsal_title"]').val(tutor_rehearsal_title);
        $('.tutor_rehearsal_description').html(tutor_rehearsal_description);
        $('input[name="tutor_rehearsal_keywords"]').val(tutor_rehearsal_keywords);
        $('.tutor_rehearsal_subject').val(tutor_rehearsal_subject);
        $('input[name="tutor_rehearsal_date"]').val(tutor_rehearsal_date);
        $('input[name="tutor_rehearsal_date_to"]').val(tutor_rehearsal_date_to);
        $('input[name="tutor_rehearsal_hour"]').val(tutor_rehearsal_hour);
        $('input[name="tutor_rehearsal_price"]').val(tutor_rehearsal_price);
        $('input[name="tutor_rehearsal_platform"]').val(tutor_rehearsal_platform);
        $('input[name="tutor_rehearsal_link"]').val(tutor_rehearsal_link);
        $('input[name="tutor_rehearsal_identifiers"]').val(tutor_rehearsal_identifiers);
        $('input[name="tutor_rehearsal_date_limite"]').val(tutor_rehearsal_date_limite);
        
        $('input[name="tutor_rehearsal_min_student_number"]').val(tutor_rehearsal_min_student_number);
        $('input[name="tutor_rehearsal_max_student_number"]').val(tutor_rehearsal_max_student_number);
        update_modal_rehearsal.addClass("show");
    })
    
    $(document).on('click',".choice-data-type",function(e){
        if ($(this).attr("attr-doto") == "ebook") {
            $('.choice-data-type').removeClass("active");
            $(this).addClass("active");
            $('.rehearsal-table').fadeOut(100);
            $('.ebook-table').fadeIn(300);
        } else {
            $('.choice-data-type').removeClass("active");
            $(this).addClass("active");
            $('.ebook-table').fadeOut(100);
            $('.rehearsal-table').fadeIn(300);
        }
    })
    $(document).on('change',".tutor_rehearsal_type_data",function(e){
        if ($(this).find(":selected").val() == "E-Book") {
            $('.rehearsal-submit').hide(100);
            $('.ebook-submit').show(300);
        } else {
            $('.ebook-submit').hide(100);
    ...
    //close create and update modal
    $(close_button_rehearsal).click(function(){
        // create_modal_rehearsal.removeClass("show");
        update_modal_rehearsal.removeClass("show");
        // details_modal_rehearsal.removeClass("show");
        $("#tutor-rehearsal-backend-create-modal").removeClass('show');
    })
    //create announcement
    $(".submit-btn-rehearsal").on('click',function(e){
        e.preventDefault();
        var $btn = $(this).find('button[type="submit"]');
        var text_button = $(this).text();
        var $form = $('.tutor-rehearsal-form');
        var formdata = (window.FormData) ? new FormData($form[0]) : null;
        var data = (formdata !== null) ? formdata : $form.serialize();
        data.append('action','tutor_rehearsal_create');
        data.append('action_type','create');
        // var formData = $(".tutor-rehearsal-form").serialize() + '&action=tutor_rehearsal_create' + '&action_type=create';
        // console.log("yesss teste: "+data);
        $(this).html("Loading...");
        $.ajax({
            url : window._tutorobject ? announcement_url : ajaxurl,
            type : 'POST',
            ...
            success: function(data) {
                ...
                if(data.status=="success") {
                    $(".submit-btn-rehearsal").html(text_button);
                    location.reload();
                }

                if(data.status=="validation_error"){
                    $(".submit-btn-rehearsal").html(text_button);
                    $(".tutor-rehearsal-create-alert").append(`<div class="tutor-alert alert-warning"></div>`);
                    for(let [key,value] of Object.entries(data.message)){
                        
                        $(".tutor-rehearsal-create-alert .tutor-alert").append(`<li>${value}</li>`);
                    }
                }                
                if(data.status=="fail"){
                    $(".submit-btn-rehearsal").html(text_button);
                    
                    $(".tutor-rehearsal-create-alert").html(`<li>${data.message}</li>`);
                
                }            
            },
            error: function(data){
                $(".submit-btn-rehearsal").html(text_button);
                $(".tutor-rehearsal-create-alert").html(`<li>An error occured. Please try again later.</li>`);
                console.log(data);
            }
        })
    })
    //update announcement
    $(".submit-btn-edit-rehearsal").on('click',function(e){
        e.preventDefault();
        var $btn = $(this).find('button[type="submit"]');
        var text_button = $(this).text();
        // var formData  = $(".tutor-rehearsal-update-form").serialize() + '&action=tutor_rehearsal_create' + '&action_type=update';
        var $form = $('.tutor-rehearsal-update-form');
        var formdata = (window.FormData) ? new FormData($form[0]) : null;
        var data = (formdata !== null) ? formdata : $form.serialize();
        data.append('action','tutor_rehearsal_create');
        data.append('action_type','update');
        $(this).html("Loading...");
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                $(".submit-btn-edit-rehearsal").html(text_button);
                ...
                if(data.status=="validation_error"){
                    $(".tutor-rehearsal-update-alert").append(`<div class="tutor-alert alert-warning"></div>`);
                    for(let [key,value] of Object.entries(data.message)){
                        $(".tutor-rehearsal-update-alert > .tutor-alert").append(`<li>${value}</li>`);
                    }
                }                
                if(data.status=="fail"){
    ...
    $(".delete-btn").click(function(){
        var $btn = $(this);
        var rehearsal_id = $(this).attr('rehearsal-id');
        var whichtr = $("#tutor-rehearsal-tr-"+rehearsal_id);
        if(confirm("Do you want to delete ?")){
            $.ajax({
                url : window._tutorobject ? announcement_url : ajaxurl,
                type : 'POST',
                data : {action:'tutor_rehearsal_delete',rehearsal_id:rehearsal_id},
                beforeSend: function() {
                    $btn.addClass('tutor-updating-message');
                },
                success: function(data) {
                    whichtr.remove();
                    // if(details_modal_rehearsal.length){
                    $btn.removeClass('tutor-updating-message');
                    // details_modal_rehearsal.removeClass('show');
    ...
    $(".delete_account_button").on('click',function(e){
        e.preventDefault();
        var $btn = $(this);
        var text_button = $(this).text();
        // var $form = $('.tutor-rehearsal-form');
        ...
        // var data = (formdata !== null) ? formdata : $form.serialize();
        data.append('user_id',$(this).attr('attr-id'));
        data.append('_tutor_nonce', $('#_tutor_nonce').val())
        data.append('action','tutor_delete_account_user');
        data.append('action_type','create');
        if(confirm("Are you sure you want to delete your account ?")){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.status=="success") {
                        $(".delete_account_button").html(text_button);
                        $(".tutor-delete_account-create-alert").html(`<li>${data.message}</li>`);
                        // location.reload();
                        window.location.href = "/";
                    }
                    ...
                    if(data.status=="validation_error"){
                        $(".delete_account_button").html(text_button);
                        $(".tutor-delete_account-create-alert").append(`<div class="tutor-alert alert-warning"></div>`);
                        for(let [key,value] of Object.entries(data.message)){
                            
                            $(".tutor-delete_account-create-alert .tutor-alert").append(`<li>${value}</li>`);
                        }
                    }                
                    if(data.status=="fail"){
                        $(".delete_account_button").html(text_button);
                ...
                error: function(data){
                    $(".delete_account_button").html(text_button);
                    $(".tutor-delete_account-create-alert").html(`<li>An error occured. Please try again later.</li>`);
                    console.log(data);
                }
            })
        }
