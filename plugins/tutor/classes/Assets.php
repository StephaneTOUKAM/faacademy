...
class Assets{
	...
	public function admin_scripts(){
		...
		if ( ! empty($_GET['taxonomy']) && ( $_GET['taxonomy'] === 'course-category' || $_GET['taxonomy'] === 'course-tag'|| $_GET['taxonomy'] === 'course-topic' || $_GET['taxonomy'] === 'course-subject'|| $_GET['taxonomy'] === 'course_level') ){
