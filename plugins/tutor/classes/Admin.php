...
class Admin{
	...
	public function register_menu(){
		...
		// add_submenu_page('tutor', __('Testage', 'tutor'), __('Testage', 'tutor'), 'manage_tutor', 'edit-tags.php?taxonomy=course-testage&post_type='.$course_post_type, null );
		...
		add_submenu_page('tutor', __('Subjects', 'tutor'), __('Subjects', 'tutor'), 'manage_tutor', 'edit-tags.php?taxonomy=course-subject&post_type='.$course_post_type, null );

		add_submenu_page('tutor', __('Themes', 'tutor'), __('Themes', 'tutor'), 'manage_tutor', 'edit-tags.php?taxonomy=course-topic&post_type='.$course_post_type, null );
		
		add_submenu_page('tutor', __('Levels', 'tutor'), __('Levels', 'tutor'), 'manage_tutor', 'edit-tags.php?taxonomy=course_level&post_type='.$course_post_type, null );
	...
	public function submenu_file_active($submenu_file, $parent_file){
		...
		// if ($taxonomy === 'course-testage'){
		// 	return 'edit-tags.php?taxonomy=course-testage&post_type='.$course_post_type;
		// }
		if ($taxonomy === 'course-subject'){
			return 'edit-tags.php?taxonomy=course-subject&post_type='.$course_post_type;
		}
		if ($taxonomy === 'course-tag'){
			return 'edit-tags.php?taxonomy=course-tag&post_type='.$course_post_type;
		}
		if ($taxonomy === 'course_level'){
			return 'edit-tags.php?taxonomy=course_level&post_type='.$course_post_type;
		}
