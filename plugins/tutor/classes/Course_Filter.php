...
class Course_Filter{
    ...
    private $topic= 'course-topic';
    private $subject='course-subject';
    private $testage='course-testage';
    ...
    public function load_listing(){
        ...
        // Prepare taxonomy
        foreach(array('category', 'course_level','tag','topic','subject','testage') as $taxonomy) {
