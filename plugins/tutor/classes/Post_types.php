...
class Post_types{
	...
	public function register_course_post_types() {
		...
		$args = array(
			...
			'hierarchical'              => false,
			'menu_position'             => null,
			'taxonomies'                => array( 'course-category', 'course-subject', 'course_level','course-topic' ),
		...
		$labels = array(
			'name'                       => _x( 'Course Testage', 'taxonomy general name', 'tutor' ),
			'singular_name'              => _x( 'Testage', 'taxonomy singular name', 'tutor' ),
			'search_items'               => __( 'Search Testage', 'tutor' ),
			'popular_items'              => __( 'Popular Testage', 'tutor' ),
			'all_items'                  => __( 'All Testage', 'tutor' ),
			'parent_item'                => null,
			'parent_item_colon'          => null,
			'edit_item'                  => __( 'Edit Testage', 'tutor' ),
			'update_item'                => __( 'Update Testage', 'tutor' ),
			'add_new_item'               => __( 'Add New Testage', 'tutor' ),
			'new_item_name'              => __( 'New Testage Name', 'tutor' ),
			'separate_items_with_commas' => __( 'Separate testage with commas', 'tutor' ),
			'add_or_remove_items'        => __( 'Add or remove testage', 'tutor' ),
			'choose_from_most_used'      => __( 'Choose from the most used testage', 'tutor' ),
			'not_found'                  => __( 'No testage found.', 'tutor' ),
			'menu_name'                  => __( 'Course testage', 'tutor' ),
		);
		...
		$args = array(
			...
			'query_var'             => true,
			'show_in_rest'          => true,
			'rewrite'               => array( 'slug' => 'course-testage' ),
		);

		// register_taxonomy( 'course-testage', $this->course_post_type, $args );
		...
		$labels = array(
			'name'                       => _x( 'Course subject', 'taxonomy general name', 'tutor' ),
			'singular_name'              => _x( 'Subject', 'taxonomy singular name', 'tutor' ),
			'search_items'               => __( 'Search Subjects', 'tutor' ),
			'popular_items'              => __( 'Popular Subjects', 'tutor' ),
			'all_items'                  => __( 'All Subjects', 'tutor' ),
			'parent_item'                => null,
			'parent_item_colon'          => null,
			'edit_item'                  => __( 'Edit Subject', 'tutor' ),
			'update_item'                => __( 'Update Subject', 'tutor' ),
			'add_new_item'               => __( 'Add New Subject', 'tutor' ),
			'new_item_name'              => __( 'New Subject Name', 'tutor' ),
			'separate_items_with_commas' => __( 'Separate Subject with commas', 'tutor' ),
			'add_or_remove_items'        => __( 'Add or remove Subject', 'tutor' ),
			'choose_from_most_used'      => __( 'Choose from the most used Subjects', 'tutor' ),
			'not_found'                  => __( 'No Subjects found.', 'tutor' ),
			'menu_name'                  => __( 'Course Subject', 'tutor' ),
		);
		...
		register_taxonomy( 'course-subject', $this->course_post_type, $args );



		$labels = array(
			'name'                       => _x( 'Course Theme', 'taxonomy general name', 'tutor' ),
			'singular_name'              => _x( 'Theme', 'taxonomy singular name', 'tutor' ),
			'search_items'               => __( 'Search Themes', 'tutor' ),
			'popular_items'              => __( 'Popular Themes', 'tutor' ),
			'all_items'                  => __( 'All Themes', 'tutor' ),
			'parent_item'                => null,
			'parent_item_colon'          => null,
			'edit_item'                  => __( 'Edit Theme', 'tutor' ),
			'update_item'                => __( 'Update Theme', 'tutor' ),
			'add_new_item'               => __( 'Add New Theme', 'tutor' ),
			'new_item_name'              => __( 'New Topic Theme', 'tutor' ),
			'separate_items_with_commas' => __( 'Separate Theme with commas', 'tutor' ),
			'add_or_remove_items'        => __( 'Add or remove Theme', 'tutor' ),
			'choose_from_most_used'      => __( 'Choose from the most used Themes', 'tutor' ),
			'not_found'                  => __( 'No Themes found.', 'tutor' ),
			'menu_name'                  => __( 'Course Themes', 'tutor' ),
		);
		...
		register_taxonomy( 'course-topic', $this->course_post_type, $args );



		$labels = array(
			'name'                       => _x( 'Course Level', 'taxonomy general name', 'tutor' ),
			'singular_name'              => _x( 'Level', 'taxonomy singular name', 'tutor' ),
			...
			'new_item_name'              => __( 'New  Level', 'tutor' ),
			'separate_items_with_commas' => __( 'Separate Level with commas', 'tutor' ),
			'add_or_remove_items'        => __( 'Add or remove Level', 'tutor' ),
			'choose_from_most_used'      => __( 'Choose from the most used Level', 'tutor' ),
			'not_found'                  => __( 'No Levels found.', 'tutor' ),
			'menu_name'                  => __( 'Course Levels', 'tutor' ),
		);
		...
		$args = array(
			...
			'query_var'             => true,
			'show_in_rest'          => true,
			'rewrite'               => array( 'slug' => 'course_level' ),
		);

		register_taxonomy( 'course_level', $this->course_post_type, $args );
