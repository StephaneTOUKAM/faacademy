...
<div>    
    ...
    <div>
        <?php
            ...
            if(in_array('topic', $supported_filters)){
                ?>
                <div>
                    <h4><?php _e('Topic', 'tutor'); ?></h4>
                    <?php $filter_object->render_terms('topic'); ?>
                </div>
                <?php
            }

            if(in_array('subject', $supported_filters)){
                ?>
                <div>
                    <h4><?php _e('Subject', 'tutor'); ?></h4>
                    <?php $filter_object->render_terms('subject'); ?>
                </div>
                <?php
            }
