...
<div class="top-bar-user-links">
	<div class="link-wrap">
		<a href="<?php echo get_bloginfo('wpurl').'/'.ICL_LANGUAGE_CODE.'/make-donation';//""; ?>" class="make-don-top-bar" style="background: #ffbc01;padding: 5px 25px;border-radius: 7px;color: black;font-weight: bold;"><span class="fa fa-donate" style="margin-right: 8px;font-size: 15px;"></span><?php esc_html_e( 'Make a donation', 'edumall' ); ?></a>
