	...
	class Edumall_WP_Widget_Init {
		...
		public function register_widgets() {
			...
			if ( Edumall_Tutor::instance()->is_activated() ) {
				...
				require_once( get_stylesheet_directory(). '/widgets/tutor/course-instructor-filter.php' );
				...
				//require_once EDUMALL_WIDGETS_DIR . '/tutor/course-subjects.php';
				//require_once EDUMALL_WIDGETS_DIR . '/tutor/course-themes.php';
				...
				//require_once EDUMALL_WIDGETS_DIR . '/tutor/popular-courses.php';
				require_once( get_stylesheet_directory(). '/widgets/tutor/popular-courses.php' ); 
				//require_once EDUMALL_WIDGETS_DIR . '/tutor/test.php';
				...
				register_widget( 'Edumall_WP_Widget_Course_Subjects' );
				register_widget( 'Edumall_WP_Widget_Course_Themes' );
				register_widget( 'Edumall_WP_Widget_Popular_Courses' );
				register_widget( 'Edumall_WP_Widget_Course_Subject_Filter' );
