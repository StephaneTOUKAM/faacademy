...
if ( ! class_exists( 'Edumall_WP_Widget_Course_Subjects' ) ) {
	class Edumall_WP_Widget_Course_Subjects extends Edumall_WP_Widget_Base {
		...
		public function __construct() {
			...
			$this->widget_cssclass    = 'edumall-wp-widget-course-subject';
		...
		public function widget( $args, $instance ) {
			...
			if ( is_tax( 'course-subject' ) ) {
				...
				if ( $terms ) {
					$main_term           = apply_filters( 'edumall_course_subject_widget_main_term', $terms[0], $terms );
