	...
	<div id="page-content" class="page-content">
		<div class="container">
			<div class="row">
				...
				<div id="page-main-content" class="page-main-content" style="padding: 4rem;">
					...
					<?php if ( ! empty( $instructors ) ) : ?>
						...
						<div class="row">
                            ...
                            <?php foreach ( $instructors as $instructor ): ?>
                                ...
                                $rehearsal_courses = new WP_Query( $args1 );
                                $total_rehearsal_courses = 0;
                                $total_ebook = 0;
                                if ( $rehearsal_courses->have_posts() ){
                                    foreach ( $rehearsal_courses->posts as $post ){
                                        if ( $post->post_excerpt == "rehearsal-course-".$instructor->ID && get_post_meta($post->ID, "tutor_rehearsal_type_data", true) == "Rehearsal Course"){
                                            $total_rehearsal_courses = $total_rehearsal_courses + 1;
                                        }
                                        if ( $post->post_excerpt == "rehearsal-course-".$instructor->ID && get_post_meta($post->ID, "tutor_rehearsal_type_data", true) == "E-Book"){
                                ...
                                <div class="col-md-4">
                                    <a href="<?php echo esc_url( $profile_url ); ?>"
                                        ...
                                        <div class="loop-instructor-header" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
                                            ...
                                            <div class="row-flex">
                                                ...
                                                <div class="col-grow">
                                                    <div class="loop-instructor-meta">
                                                        ...
                                                        <span class="meta-value">
                                                            <?php echo esc_html( sprintf(
                                                                _n( '%s rehearsals courses', '%s rehearsals courses', $total_rehearsal_courses, 'edumall' ),
                                                                number_format_i18n( $total_rehearsal_courses )
                                                            ) ); ?>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-grow">
                                                    <div class="loop-instructor-meta">
                                                        ...
                                                        <span class="meta-value">
                                                            <?php echo esc_html( sprintf(
                                                                _n( '%s e-books', '%s e-books', $total_ebook, 'edumall' ),
                                                                number_format_i18n( $total_ebook )
                                                            ) ); ?>
                                                        </span>
                                                    </div>
                                                </div>
