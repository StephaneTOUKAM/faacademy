...
if ( ! class_exists( 'Edumall_Archive_Course' ) ) {
	class Edumall_Archive_Course {
		...
		public function initialize() {
			...
			add_action( 'edumall_after_main_content', [ $this, 'add_course_tabs' ], 20 );
			add_action( 'edumall_after_main_content', [ $this, 'add_featured_courses' ], 20 );
			add_action( 'edumall_after_main_content', [ $this, 'add_popular_topics' ], 30 );
			add_action( 'edumall_after_main_content', [ $this, 'add_popular_instructors' ], 40 );
