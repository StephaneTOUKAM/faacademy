...
<div class="tutor-single-course-meta tutor-meta-top">
	...
	<?php if ( '1' !== get_tutor_option( 'disable_course_level' ) ) { ?>
		<div class="tutor-course-level">
			...
			<div class="meta-value"><?php Edumall_Tutor::instance()->entry_course_levels();  ?></div>
		</div>
	<?php } ?>
	...
	<?php Edumall_Tutor::instance()->entry_course_topics(); ?>
	<?php Edumall_Tutor::instance()->entry_course_subjects(); ?>
	<?php //Edumall_Tutor::instance()->entry_course_levels(); ?>
