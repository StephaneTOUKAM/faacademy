	...
	<div class="tutor-modal-content tutor-announcement-modal-content">
		<div class="modal-header">
			<div class="modal-title">
				<h1><?php esc_html_e( 'Create New E-Book', 'edumall' ); ?></h1>
			</div>
		...
		<div class="modal-container">
			<form action="" class="tutor-rehearsal-form" enctype="multipart/form-data">
				...
				<div class="tutor-form-group">
					<input name="tutor_rehearsal_type_data" type="hidden" value="E-Book">
				</div>
				<div class="tutor-form-group">
					<label>
				...
				<div class="tutor-form-group ebook-submit">
					<label>
				...
				<section class="rehearsal-submit" style="display:none;">
					<div class="tutor-form-group">
						<label>
							<?php esc_html_e( 'Select offer type', 'edumall' ); ?>
						</label>
						<select class="ignore-nice-select" name="tutor_rehearsal_type" required>
					...
					<div class="tutor-form-group">
						...
						<select class="ignore-nice-select" name="tutor_rehearsal_subject" required>
							<?php if ( $subjects ) : ?>
					...
					<div class="tutor-form-group">
						...
						<input type="text" name="tutor_rehearsal_platform" value=""
							placeholder="<?php esc_html_e( 'Platform', 'edumall' ); ?>" required>
					</div>
					<div class="tutor-form-group">
						<label>
					...
					<div class="tutor-form-group">
						...
						<input type="url" name="tutor_rehearsal_identifiers" value=""
				...
				<div class="modal-footer">
					<button type="submit" class="tutor-btn submit-btn-rehearsal"><?php esc_html_e( 'Publish', 'edumall' ) ?></button>
					<button type="button"
