...
/**
 * WPML: get_qa_questions() ignores the current language, so filter the
 * questions down to it here based on their linked course.
 */
$questions = edumall_wpml_filter_items_by_course_id( $questions, function ( $question ) {
	return $question->comment_post_ID;
} );
?>
