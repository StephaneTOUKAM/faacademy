...
<style>
	.tutor-dashboard-permalinks li.tutor-dashboard-menu-notifications a:before{
		content: "\f114";
	}
	.tutor-dashboard-permalinks li.tutor-dashboard-menu-rehearsal-courses a:before{
		content: "\f112";
	}
	.tutor-dashboard-permalinks li.tutor-dashboard-menu-exam-preparation-courses a:before{
		content: "\f112";
	}
	.tutor-dashboard-permalinks li.tutor-dashboard-menu-ebooks a:before{
		content: "\f112";
	}
	.tutor-dashboard-permalinks li.tutor-dashboard-menu-chat a:before{
		content: "\f114";
	}
</style>
