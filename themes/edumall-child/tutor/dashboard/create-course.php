							...
							<div class="tutor-course-builder-section tutor-course-builder-info">
								...
								<div class="tutor-course-builder-section-content">
									...
									<div class="tutor-frontend-builder-item-scope">
										<div class="tutor-form-group">
											<label>
												<?php esc_html_e( 'Choose a level', 'edumall' ); ?>
											</label>
											<div class="tutor-form-field-course-categories">
												<?php //echo tutor_course_categories_checkbox($course_id);
												echo tutor_course_levels_dropdown( $course_id, array( 'classes' => 'tutor_select2' ) );
												?>
											</div>
										</div>
									</div>
									...
									<div class="tutor-frontend-builder-item-scope">
										<div class="tutor-form-group">
											<label>
												<?php esc_html_e( 'Choose a subject', 'edumall' ); ?>
											</label>
											<div class="tutor-form-field-course-categories">
												<?php //echo tutor_course_categories_checkbox($course_id);
												echo tutor_course_subjects_dropdown( $course_id, array( 'classes' => 'tutor_select2' ) );
												?>
											</div>
										</div>
									</div>
									<div class="tutor-frontend-builder-item-scope">
										<div class="tutor-form-group">
											<label>
												<?php esc_html_e( 'Choose a theme', 'edumall' ); ?>
											</label>
											<div class="tutor-form-field-course-categories">
												<?php //echo tutor_course_categories_checkbox($course_id);
												echo tutor_course_topics_dropdown( $course_id, array( 'classes' => 'tutor_select2' ) );
												?>
											</div>
										</div>
									</div>
												...
												<div class="tutor-row tutor-align-items-center">
													<div class="tutor-col-auto">
														<label for="tutor_course_price_type_pro"
															...
															<span></span>
															<?php esc_html_e( 'Regular Price', 'edumall' ); ?>
															<div class="tutor-form-group">
													...
													<div class="tutor-col-auto">
														...
														<label for="tutor_course_price_type_pro"
														       class="tutor-styled-radio">
															<?php esc_html_e( 'Sale  Price', 'edumall' ); ?>
															<div class="tutor-form-group">
																<span
																class="tutor-input-prepand"><?php echo esc_html( $currency_symbol ); ?></span>
																<form method="POST">
																	<input type="text" name="_sale_price" id="_sale_price"
																		value="<?php echo esc_attr( get_post_meta($product_id,'_sale_price',true) ); ?>"
																		placeholder="<?php esc_attr_e( 'Set course price', 'edumall' ); ?>">
																</form>	
															</div>
