...
?>
    <a style="color: #2371b7;" href="/my-account/visualiser-la-commande/<?= $order->ID ?>">#<?= $order->ID ?></a>
<?php 
    }elseif(ICL_LANGUAGE_CODE == 'en'){
?>
    <a style="color: #2371b7;" href="/en/my-account/view-order/<?= $order->ID ?>">#<?= $order->ID ?></a>
<?php 
    }elseif(ICL_LANGUAGE_CODE == 'de'){
?>
    <a style="color: #2371b7;" href="/de/my-account/auftrag-anzeigen/<?= $order->ID ?>">#<?= $order->ID ?></a>
<?php 
    }
?>
						</td>
