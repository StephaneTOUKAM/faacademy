...
/**
 * WPML: get_assigned_courses_ids_by_instructors() ignores the current
 * language, so filter the course IDs down to it here.
 */
$course_id = edumall_wpml_filter_course_ids( $course_id );
