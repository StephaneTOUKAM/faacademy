...
<div class="tutor-dashboard-content-inner edumall-animation-zoom-in">
	...
	/**
	 * WPML: get_courses_by_instructor() runs raw SQL and ignores the current
	 * language, so filter the instructor's courses down to it here.
	 */
	$my_courses = edumall_wpml_filter_items_by_course_id( $my_courses, function ( $course ) {
		return $course->ID;
	} );
	?>
