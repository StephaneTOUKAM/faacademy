...
/**
 * WPML: get_courses()/get_courses_by_instructor() ignore the current
 * language, so filter the course filter dropdown down to it here.
 */
$courses = edumall_wpml_filter_items_by_course_id( $courses, function ( $course ) {
	return $course->ID;
} );
