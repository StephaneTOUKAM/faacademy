			...
			<div class="row">
				<div class="col-md-12">
					<div class="tutor-dashboard-header">
						...
						<?php if (current_user_can(tutor()->instructor_role) && defined('ICL_SITEPRESS_VERSION')) : ?>
							<div class="tutor-dashboard-header-language-switcher">
								<?php
								do_action('wpml_add_language_selector', [
									'template' => 'wpml-legacy-dropdown',
									'flags'    => 1,
								]);
								?>
							</div>
